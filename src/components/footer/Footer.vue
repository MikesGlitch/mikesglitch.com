    ...
    <div class="container">
      ...
      <div class="flex flex-col gap-2.5 w-full h-full">
        <div class="flex gap-2 align-middle items-center">
          ...
          <span>Made by <LinkExternal title="Message me" href="https://www.linkedin.com/in/mikesglitch" text="Michael Clark" /> 2020 – present</span>
        </div>
        <div class="flex gap-2 align-middle items-center">
          <span class="w-8">🔨</span> Built with <link-external title="Vue" href="https://vuejs.org/" text="Vue" /> & <link-external title="Nuxt" href="https://v3.nuxtjs.org/" text="Nuxt" /> on <link-external title="Vercel" href="https://vercel.com/" text="Vercel" />
        </div>

<template>
  <div class="">
      ...
      <div class="container flex py-4 sm:py-24">
        <div class="flex flex-col justify-center gap-6">
          ...
          <div class="flex gap-4 items-center">
            <LinkButtonInternal to="/projects" text="Got a project?" />
            <ButtonPrimary title="Let's talk" label="Let's talk" @click="onScrollToContactForm()" />
          </div>
    ...
    <div class="container flex py-4 sm:py-24">
      <div class="flex flex-col sm:flex-row gap-10">
        <div class="min-w-[300px]">
          ...
          <ButtonPrimary class="mt-4" title="Let's talk" label="Let's talk" @click="onScrollToContactForm()" />
        </div>
        ...
        <div class="container flex py-4 sm:py-24">
          <div class="flex flex-col gap-5 w-full">
            ...
            <div class="grid sm:grid-cols-2 gap-5">
              <div v-for="(client, idx) of clients" :key="idx" class="w-full dark:bg-gray-dark bg-white rounded-md px-16 py-11">
                <div class="flex flex-col gap-4">
    ...
    <div class="container flex flex-col gap-24 mt-24">
